...
Talking of learning Blender, here’s a small demo of Claude giving a walkthrough
of Blender’s tools.

<a href="docs/media/annotate-blender-demo.mp4"><img src="docs/media/blender-demo.gif" width="800" alt="Claude numbering and labelling Blender's left toolbar in turn — Select, 3D Cursor, Move, Rotate, Scale, Transform, Annotate — each one looped and captioned live on the real window"></a>

[**Watch the full walkthrough →**](docs/media/annotate-blender-demo.mp4)
